                ...
                <form method="POST" action="../../Controller/Empresa/Empresa_Controller.php">
                    <div class="container">
                        ...
                        <div class="col text-center">
                            <button onclick="cambiarClave();" id="btn_cambiar_clave" type="button" name="btn_editar_perfil" style="background-color: #D61117; color: white;" class="btn">Cambiar clave</button>
                        </div>
                    </div>
                </form>
