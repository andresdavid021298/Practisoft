                ...
                <div class="container">
                    <div class="row">
                        <div class="col text-center">
                            ...
                            $representante = mostrarDatosRepresentante($id_empresa);
                            ?>
                            <form id="formRepresentante" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="fileUpload btn">
                                    <label>Archivo</label>
                                    <input id="input_archivo_representante" type="file" name="input_archivo_representante" />
                                </div>
                                <button onclick="subirRepresentante();" id="btn_subir_rep" type="button" value="Enviar" name="btn_subir_rep" class="btn btn-primary">Cargar</button>
