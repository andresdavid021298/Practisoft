                            ...
                            <?php } else { ?>
                                ...
                                <form id="formConvenio" method="POST" enctype="multipart/form-data">
                                    ...
                                    <label class="custom-file-upload">
                                        <input type="file" id="input_archivo_carta" name="input_archivo_carta" onchange="obtenerNombre()" />
                                    ...
                                    <button id="btn_subir_carta" type="button" value="Enviar" name="btn_subir_carta" class="btn btn-primary" onclick="subirCartaCompromisoria()">Subir</button>
...
<script>
    function obtenerNombre() {
        documento = document.getElementById('input_archivo_carta').files[0];
