...
class ActividadPlanTabajoModel
{
    ...
    {
        $query = "SELECT id_actividad_plan_trabajo, descripcion_actividad_plan_trabajo, numero_horas_actividad_plan_trabajo,estado FROM actividades_plan_trabajo WHERE id_estudiante=:id";
